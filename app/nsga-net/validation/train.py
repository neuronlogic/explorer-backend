...
parser.add_argument(
    "--init_channels", type=int, default=32, help="num of init channels"
)
parser.add_argument(
    "--arch", type=str, default="NSGANet", help="which architecture to use"
)
parser.add_argument(
    "--filter_increment", default=4, type=int, help="# of filter increment"
)
parser.add_argument(
    "--SE",
    action="store_true",
...
parser.add_argument(
    "--net_type", type=str, default="micro", help="(options)micro, macro"
)
...
def train(train_queue, net, criterion, optimizer):
    ...
    logging.info("train acc %f", 100.0 * correct / total)
...
def infer(valid_queue, net, criterion):
    ...
    logging.info("valid acc %f", 100.0 * correct / total)
