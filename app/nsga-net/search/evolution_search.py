...
sys.path.insert(0, "../naschain_nas")
...
parser.add_argument(
    "--save", type=str, default="GA-BiObj", help="experiment name"
)
...
parser.add_argument(
    ...
    type=str,
    default="micro",
    help="macro or micro search space",
)
# arguments for micro search space
parser.add_argument(
    "--n_blocks", type=int, default=5, help="number of blocks in a cell"
)
parser.add_argument(
    "--n_ops", type=int, default=9, help="number of operations considered"
)
parser.add_argument(
    "--n_cells", type=int, default=2, help="number of cells to search"
)
# arguments for macro search space
parser.add_argument(
    "--n_nodes", type=int, default=4, help="number of nodes per phases"
)
# hyper-parameters for algorithm
parser.add_argument(
    "--pop_size", type=int, default=40, help="population size of networks"
)
...
parser.add_argument(
    "--init_channels", type=int, default=24, help="# of filters for first cell"
)
parser.add_argument(
    "--layers", type=int, default=11, help="equivalent with N = 3"
)
parser.add_argument(
    "--epochs",
    type=int,
...
class NAS(Problem):
    ...
    def __init__(
        ...
        super().__init__(
            n_var=n_var, n_obj=n_obj, n_constr=n_constr, type_var=np.int
        )
        self.xl = lb
        self.xu = ub
        ...
        self._n_evaluated = (
            0  # keep track of how many architectures are sampled
        )
