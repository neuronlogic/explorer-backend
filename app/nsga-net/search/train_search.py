...
def main(
    ...
    # combined_queue = torch.utils.data.DataLoader(
    #     combined_data, batch_size=batch_size,
    ...
    ##
    # register_detailed_hooks(model)
    # output = model(dummy_input)
    ##

    torch.save(model, save_pth + "/" + str(search_space) + ".pt")
    ...
    # save_file(state_dict, 'micro.safetensors')
